  ...
  return (
    <Form form={form}>
      <div className="col-span-full grid grid-cols-6 gap-3">
        ...
        {/* <InputGroupWrapper
          label="Ajouter Plus de Details (Optionnel)"
          className="col-span-full"
        >
          <p className="mt-2 text-sm font-normal text-gray-600">
            Cette partie est optionnelle. Si vous souhaitez la repmpli, mettez le niveau auquel vous excellez dans chaque domaine.
          </p>
        </InputGroupWrapper> */}

...
export const ResumePDFProfile = ({
  ...
  // Function to transform name to first letter + last two letters
  ...
  return (
    <ResumePDFSection>
      ...
      <View style={{ ...styles.flexRowBetween, alignItems: "center", marginBottom: spacing["4"] }}>
        <Image src={logoTelecomBase64} style={{ width: 45, height: 45, marginRight: spacing["2"] }} />
        <View style={{ flex: 1, marginLeft: spacing["2"] }}>
          <View>
            <Text style={{ fontSize: "12pt", color: "#444", fontWeight: "bold" }}>
              R&S TELECOM
            </Text>
      ...
      <View style={{ ...styles.flexRowBetween, flexWrap: "wrap" }}>
        ...
        <View style={{ flex: 1, alignItems: "flex-end" }}>
          ...
          <Text style={{ fontSize: "12pt", color: "#888", marginTop: spacing["1"] }}>
            {summary}
          </Text>
